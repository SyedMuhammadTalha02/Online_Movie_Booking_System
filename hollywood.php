        		...
        		<div class="card card--list" style="background:transparent;padding:15px 15px;box-shadow: 0 5px 25px 0 rgb(0 0 0 / 30%);">
			            <div class="row">
									...
									<!-- veiw more detail btn -->
									  ...
									  <a   href="moviedetail.php?movdet=<?php echo $data['movie_id'];?>"    class="form-control text-center" style="background-image: -webkit-linear-gradient(0deg, #ff55a5 0%, #ff5860 100%);color:white;border:none;">Movie Details & Booking</a>
