                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <div class="row">
                            <div class="col-md-4">
                              <input type="text" placeholder="Gold-Class" class="form-control"   name="movie_select_eco">
                            </div>
                            <div class="col-md-4">
                              <input type="text" placeholder="Platinum-Class" class="form-control"  name="movie_select_bus">
                            </div>
                            <div class="col-md-4">
                              <input type="text" placeholder="Box-Class" class="form-control"  name="movie_select_frt">
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-9 ml-auto">
                          <button type="submit" class="btn btn-secondary" style="background-image: linear-gradient(90deg, #ff55a5 0%, #ff5860 100%);" name="movie_price_btn">Add Movie Price</button>
                        </div>
                    </form>
                  </div>
                </div>
