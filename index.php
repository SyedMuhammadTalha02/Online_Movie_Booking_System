...
?>
 ...
 <div class="wrapper mb-5">
    <div class="typing-demo">
      book your tickets for <span style="color:#ff55a5;text-shadow: 2px 2px 20px #ff5860;">movies</span>
    </div>
 </div>
 ...
 <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/home/fastxx.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/home/mario.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/home/little.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/home/missi.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/home/themeg.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/home/ambulance.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/home/mi6.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
						...
						<div class="col-6 col-sm-12 col-lg-6">
							<div class="card card--list" style="background:transparent;border:none;padding:15px 15px;box-shadow: 0 5px 25px 0 rgb(0 0 0 / 30%);">
									...
									<div class="col-12 col-sm-8">
										<div class="card__content">
											...
											<span class="card__category">
												<a href="#" style="background-image: -webkit-linear-gradient(0deg, #ff55a5 0%, #ff5860 100%);">
												<?php  
								...
								<div class="container-fluid">
                                    ...
                                    <a   href="moviedetail.php?movdet=<?php echo $ux_sel_data['movie_id'];?>"    class="form-control text-center" style="background-image: -webkit-linear-gradient(0deg, #ff55a5 0%, #ff5860 100%);color:white;border:none;">Movie Details & Booking</a>
							...
							<div class="card card--list" style="background:transparent;padding:15px 15px;box-shadow: 0 5px 25px 0 rgb(0 0 0 / 30%);">
								<div class="row">
									...
									<!-- veiw more detail btn -->
									  ...
									  <a   href="moviedetail.php?movdet=<?php echo $ux_else_data['movie_id'];?>"    class="form-control text-center" style="background-image: -webkit-linear-gradient(0deg, #ff55a5 0%, #ff5860 100%);color:white;border:none;">Movie Details & Booking</a>
						...
						<div class="col-6 col-sm-12 col-lg-6">
							<div class="card card--list" style="background:transparent;border:none;padding:15px 15px;box-shadow: 0 5px 25px 0 rgb(0 0 0 / 30%);">
								<div class="row">
                                    ...
                                    <a   href="moviedetail.php?movdet=<?php echo $ux_srch_data['movie_id'];?>"    class="form-control text-center" style="background-image: -webkit-linear-gradient(0deg, #ff55a5 0%, #ff5860 100%);color:white;border:none;">Movie Details & Booking</a>
			...
			<div class="row">
				...
				<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
					<div class="card" style="background:transparent;border:none;">
						<div class="card__cover">
							<img src="img/covers/miss.jpg" alt="">
							<a href="#" class="card__play">
								<i class="icon ion-ios-play"></i>
							</a>
						</div>
						<div class="card__content">
							<h3 class="card__title"><a href="#">Mission Impossible 07</a></h3>
							<span class="card__category">
								<a href="#">Action</a>
								<a href="#">Triler</a>
							</span>
				...
				<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
					<div class="card" style="background:transparent;border:none;">
						<div class="card__cover">
							<img src="img/covers/flash.jpg" alt="">
							<a href="#" class="card__play">
								<i class="icon ion-ios-play"></i>
							</a>
						</div>
						<div class="card__content">
							<h3 class="card__title"><a href="#">THE FLASH</a></h3>
							<span class="card__category">
								<a href="#">Adventure/Action</a>
							</span>
				...
				<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
					<div class="card" style="background:transparent;border:none;">
						<div class="card__cover">
							<img src="img/covers/meg.jpg" alt="">
							<a href="#" class="card__play">
								<i class="icon ion-ios-play"></i>
							</a>
						</div>
						<div class="card__content">
							<h3 class="card__title"><a href="#">MEG THE TRENCH</a></h3>
							<span class="card__category">
								<a href="#">Action</a>
								<a href="#">Thriller</a>
								<a href="#">Horror</a>
				...
				<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
					<div class="card" style="background:transparent;border:none;">
						<div class="card__cover">
							<img src="img/covers/ext.jpg" alt="">
							<a href="#" class="card__play">
								<i class="icon ion-ios-play"></i>
							</a>
						</div>
						<div class="card__content">
							<h3 class="card__title"><a href="#">EXTRECTION 02</a></h3>
							<span class="card__category">
								<a href="#">Action</a>
								<a href="#">Thriller</a>
							</span>
				...
				<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
					<div class="card" style="background:transparent;border:none;">
						<div class="card__cover">
							<img src="img/covers/killer.jpg" alt="">
							<a href="#" class="card__play">
								<i class="icon ion-ios-play"></i>
							</a>
						</div>
						<div class="card__content">
							<h3 class="card__title"><a href="#">THE KILLER OF
								 FLOWER MOON</a></h3>
							<span class="card__category">
								<a href="#">Action</a>
								<a href="#">Mystery</a>
				...
				<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
					<div class="card" style="background:transparent;border:none;">
						<div class="card__cover">
							<img src="img/covers/Open.jpg" alt="">
							<a href="#" class="card__play">
								<i class="icon ion-ios-play"></i>
							</a>
						</div>
						<div class="card__content">
							<h3 class="card__title"><a href="#">OPPENHEMER</a></h3>
							<span class="card__category">
								<a href="#">Action</a>
								<a href="#">Mystery</a>
							</span>
