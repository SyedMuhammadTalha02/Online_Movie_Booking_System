							...
							<div class="card card--list" style="background:transparent;border:none;padding:15px 15px;box-shadow: 0 5px 25px 0 rgb(0 0 0 / 30%);">
								<div class="row">
									...
									<!-- hidden input -->
										   ...
										   <select  name="mov_book_date" class="form-control"         style="background-image: -webkit-linear-gradient(0deg, #ff55a5 0%, #ff5860 100%);border:none;color:white;">
											...
											?>	
												...
												<select  name="mov_book_price" class="form-control"         style="background-image:   -webkit-linear-gradient(0deg, #ff55a5 0%, #ff5860 100%);border:none;  color:white;">
										   ...
										   <select  name="mov_book_seat" class="form-control"         style="background-image: -webkit-linear-gradient(0deg, #ff55a5 0%, #ff5860 100%);border:none;color:white;">
                                                             <option disabled selected>Select Your Show !</option>
                                                             <option>1</option>
                                                             <option>2</option>
                                                             <option>3</option>
                                            ...
                                            <input  type="text" name="mov_book_card"  class="form-control  mt-4" style="background-image: -webkit-linear-gradient(0deg, #ff55a5 0%, #ff5860 100%);color:white;border:none;" placeholder="5555-5555-5555-5555" pattern="[0-9]{4}-[0-9]{4}-[0-9]{4}-[0-9]{4}" autocomplete="off" required>
										   ...
										   <!-- veiw more detail btn -->
                                            <center>
                                            <input  type="submit" value="Confirm Ticket" name="mov_book_btn"  class="text-center btn mt-4" style="background-image: -webkit-linear-gradient(0deg, #ff55a5 0%, #ff5860 100%);color:white;border:none;">
										    	</center>
