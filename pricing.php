			...
			<div class="row">
				<div class="col-12">
					<div class="section__wrap">
						<!-- section title -->
						<h2 class="section__title">Ticket Prices</h2>
						<!-- end section title -->
                    ...
                    <table class="table table-striped table-hover text-white">
                      <thead>
                        ...
                        <?php 
                            ...
                            <tbody>
                                <tr>
                                    <td style='color:white;background-image: -webkit-linear-gradient(0deg, #ff55a5 0%, #ff5860 100%);'> $movie_price_data[movie_name_price] </td>
